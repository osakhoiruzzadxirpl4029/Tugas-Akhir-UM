...
#define WIFI_SSID "masha"
#define WIFI_PASSWORD "mashabolobolo"

//For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyAVMvfARcOPDp1vueoAJOeh7QMmWWbg8Ls"

/* 3. Define the RTDB URL */
#define DATABASE_URL "solenoid-door-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "khoiruzzad72@gmail.com"
#define USER_PASSWORD "osakhoiruzzad492"
...
void loop()
  {
    long pir = digitalRead(sensPIR);
    if(pir == HIGH){
      Serial.println("Detected");
      Firebase.setString(fbdo,s,"Detected");
      tone(buzzer, 1000);
      delay(1000);    
    }
    else{
      Serial.println("No Motion");
      Firebase.setString(fbdo,s,"No Motion");  
    }
    if(buzzer == HIGH){
      Firebase.setString(fbdo,b,"ON");
    }
    else{
      Firebase.setString(fbdo,b,"OFF");  
    }
